...
from DropBoxGuardian.DropBoxGuardianComponent import DropBoxGuardianComponent
...
try:
    ...
    compCfg = config.getConfig("DropBoxGuardian")
...
component = DropBoxGuardianComponent(**dict(compCfg))
