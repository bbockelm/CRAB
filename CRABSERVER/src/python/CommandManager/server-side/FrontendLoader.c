...
/*-----------------------------------------------
              @(target):= _FrontendLoader.so
  ------------------------------------------------*/
#define SWIG_init    init_FrontendLoader

#define SWIG_name    "_FrontendLoader"
extern int run_service(int,char *);
#ifdef __cplusplus
extern "C" {
#endif
...
static PyMethodDef SwigMethods[] = {
	 { (char *)"start", _wrap_start, METH_VARARGS },
	 { NULL, NULL }
};
