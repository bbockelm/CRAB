...
#endif
SOAP_FMAC3 void SOAP_FMAC4 soap_default_ns1__sendCommandType(struct soap*, struct ns1__sendCommandType *);
SOAP_FMAC3 void SOAP_FMAC4 soap_serialize_ns1__sendCommandType(struct soap*, const struct ns1__sendCommandType *);
SOAP_FMAC3 int SOAP_FMAC4 soap_put_ns1__sendCommandType(struct soap*, const struct ns1__sendCommandType *, const char*, const char*);
SOAP_FMAC3 int SOAP_FMAC4 soap_out_ns1__sendCommandType(struct soap*, const char*, int, const struct ns1__sendCommandType *, const char*);
SOAP_FMAC3 struct ns1__sendCommandType * SOAP_FMAC4 soap_get_ns1__sendCommandType(struct soap*, struct ns1__sendCommandType *, const char*, const char*);
SOAP_FMAC3 struct ns1__sendCommandType * SOAP_FMAC4 soap_in_ns1__sendCommandType(struct soap*, const char*, struct ns1__sendCommandType *, const char*);

#ifndef SOAP_TYPE_ns1__transferTaskType
#define SOAP_TYPE_ns1__transferTaskType (7)
#endif
SOAP_FMAC3 void SOAP_FMAC4 soap_default_ns1__transferTaskType(struct soap*, struct ns1__transferTaskType *);
SOAP_FMAC3 void SOAP_FMAC4 soap_serialize_ns1__transferTaskType(struct soap*, const struct ns1__transferTaskType *);
SOAP_FMAC3 int SOAP_FMAC4 soap_put_ns1__transferTaskType(struct soap*, const struct ns1__transferTaskType *, const char*, const char*);
SOAP_FMAC3 int SOAP_FMAC4 soap_out_ns1__transferTaskType(struct soap*, const char*, int, const struct ns1__transferTaskType *, const char*);
SOAP_FMAC3 struct ns1__transferTaskType * SOAP_FMAC4 soap_get_ns1__transferTaskType(struct soap*, struct ns1__transferTaskType *, const char*, const char*);
SOAP_FMAC3 struct ns1__transferTaskType * SOAP_FMAC4 soap_in_ns1__transferTaskType(struct soap*, const char*, struct ns1__transferTaskType *, const char*);
...
SOAP_FMAC3 int SOAP_FMAC4 soap_out_PointerTons1__getTaskStatusResponse(struct soap*, const char *, int, struct ns1__getTaskStatusResponse *const*, const char *);
...
SOAP_FMAC3 int SOAP_FMAC4 soap_out_PointerTons1__sendCommandResponse(struct soap*, const char *, int, struct ns1__sendCommandResponse *const*, const char *);
SOAP_FMAC3 struct ns1__sendCommandResponse ** SOAP_FMAC4 soap_get_PointerTons1__sendCommandResponse(struct soap*, struct ns1__sendCommandResponse **, const char*, const char*);
...
SOAP_FMAC3 int SOAP_FMAC4 soap_out_PointerTons1__sendCommandType(struct soap*, const char *, int, struct ns1__sendCommandType *const*, const char *);
SOAP_FMAC3 struct ns1__sendCommandType ** SOAP_FMAC4 soap_get_PointerTons1__sendCommandType(struct soap*, struct ns1__sendCommandType **, const char*, const char*);
...
SOAP_FMAC3 int SOAP_FMAC4 soap_out_PointerTons1__transferTaskAndSubmitResponse(struct soap*, const char *, int, struct ns1__transferTaskAndSubmitResponse *const*, const char *);
SOAP_FMAC3 struct ns1__transferTaskAndSubmitResponse ** SOAP_FMAC4 soap_get_PointerTons1__transferTaskAndSubmitResponse(struct soap*, struct ns1__transferTaskAndSubmitResponse **, const char*, const char*);
...
SOAP_FMAC3 int SOAP_FMAC4 soap_out_PointerTons1__transferTaskType(struct soap*, const char *, int, struct ns1__transferTaskType *const*, const char *);
SOAP_FMAC3 struct ns1__transferTaskType ** SOAP_FMAC4 soap_get_PointerTons1__transferTaskType(struct soap*, struct ns1__transferTaskType **, const char*, const char*);
SOAP_FMAC3 struct ns1__transferTaskType ** SOAP_FMAC4 soap_in_PointerTons1__transferTaskType(struct soap*, const char*, struct ns1__transferTaskType **, const char*);
