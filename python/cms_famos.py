...
# added today
        ...
        if (int(self.total_number_of_events) < int(self.events_per_ntuple)):
            log.message("Warning: the total_number_of_events required is minor then the events_per_ntuple. It must be bigger or equals")
            sys.exit()
