...
class JobType:
    ...
    def wsSetupCMSEnvironment_(self):
        ...
        txt += '   echo "JOB_EXIT_STATUS = 31" \n'
        txt += '   echo "SanityCheckCode = 31" | tee -a $RUNTIME_AREA/$repo\n'
        ...
        txt += '       echo "JOB_EXIT_STATUS = 4"\n'
        txt += '       echo "SanityCheckCode = 4" | tee -a $RUNTIME_AREA/$repo\n'
        txt += '       dumpStatus $RUNTIME_AREA/$repo\n'
        txt += '       exit 4 \n'
        txt += '   fi\n'
        ...
        txt += 'elif [[ $string = *Enterprise* ]]; then\n'
